// vulkore::Program / vulkore::Kernel — clspv-compiled SPIR-V modules.
//
...
enum class ArgKind {
  StorageBuffer,    // bind an vulkore::Buffer (descriptor set/binding below)
...
class Program {
 public:
  ...
  // device extension is required). Throws vulkore::Error on malformed SPIR-V or
